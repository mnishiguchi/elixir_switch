defmodule ElixirSwitch.LedController do
  @moduledoc """
  ...
  def start_link(gpio_pin) when is_number(gpio_pin), do: GenServer.start(__MODULE__, gpio_pin)
  ...
  def handle_info({:initialize_state, gpio_pin}, _) do
    {
      ...
      %{
        gpio_pin: gpio_pin,
        switched_on: ElixirSwitch.Led.on?(gpio_pin)
      }
    }
  end
